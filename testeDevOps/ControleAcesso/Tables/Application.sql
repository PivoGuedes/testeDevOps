CREATE TABLE [ControleAcesso].[Application] (
    [ID]           UNIQUEIDENTIFIER NOT NULL,
    [Name]         VARCHAR (80)     NOT NULL,
    [Description]  VARCHAR (255)    NULL,
    [CreationDate] DATETIME         NOT NULL,
    [Enabled]      BIT              NOT NULL,
    CONSTRAINT [PK_Application_ID] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 100, DATA_COMPRESSION = PAGE) ON [PRIMARY]
);
...
CREATE TRIGGER [ControleAcesso].[ControleAcesso_Application_ChangeTracking] on [ControleAcesso].[Application] for insert, update, delete
...
SELECT @TableName_Full = '[ControleAcesso].[Application]'
...
SELECT [ID],[Name],[Description],[CreationDate],[Enabled] INTO #ins FROM inserted

SELECT [ID],[Name],[Description],[CreationDate],[Enabled] INTO #del FROM deleted
