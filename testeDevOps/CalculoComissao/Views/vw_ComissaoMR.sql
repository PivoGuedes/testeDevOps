...
CREATE VIEW [CalculoComissao].[vw_ComissaoMR]
AS
...
ON CM.IDProduto = PRD.ID AND PRD.CodigoComercializado <> '6107'
...
--            ) PH
WHERE IDEmpresa = 3 
  AND RP.Codigo IN ('03','05') -- AUTO
  --and CodigoComercializado = '3177'
    --AND CNT.ID = 8349029
	AND CM.Arquivo <> 'COMI EXTRA REDE'
