CREATE TABLE [dbo].[SIDEC_D160512_PAR_paulo] (
...
GO
CREATE CLUSTERED INDEX [cl_idx_cc0512p]
    ON [dbo].[SIDEC_D160512_PAR_paulo]([Column 0] ASC) WITH (FILLFACTOR = 100, DATA_COMPRESSION = PAGE);
