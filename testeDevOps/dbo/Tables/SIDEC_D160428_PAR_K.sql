CREATE TABLE [dbo].[SIDEC_D160428_PAR_K] (
...
GO
CREATE CLUSTERED INDEX [cl_idx_cc_tmp1]
    ON [dbo].[SIDEC_D160428_PAR_K]([Column 0] ASC) WITH (FILLFACTOR = 100, DATA_COMPRESSION = PAGE);
