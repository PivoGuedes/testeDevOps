CREATE PROCEDURE proc_InsereAQAUTINDDbm
AS
	...
	select s.NumeroSinistro,c.NumeroContrato,pa.ValorPagamento,pa.DescricaoEfeito,pa.SeguroTerceiro, cc.NomeCliente
	...
	ON NuApolice ='1103100' +Apolice  AND DtVersaoFim ='20500101'
	 LEFT JOIN DW_MKT.DADOS.DIMUNIDADEDINAMICA G
	...
	*/
	...
	from #TEMP0 a
	left join dbm_mkt.dbo.simulador_sas s
	on a.cpf=s.cpfcnpj
	)a where rank=1
