...
/*
	...
	Última alteração : Gustavo 02/12/2013 -> Alteração da função usada para buscar as apólices
	para fn_RecuperaApolicesVigentes_PATRIMONIAL.
                                                                                      
*/

/*******************************************************************************
	Nome: CORPORATIVO.Marketing.fn_RecuperaApolicesVigentes_RESIDENCIAL_Novo
...
*******************************************************************************/ 
CREATE FUNCTION [Marketing].[fn_RecuperaApolicesVigentes_RESIDENCIAL_Novo] (@DataApuracao AS DATE)
RETURNS TABLE
AS
RETURN
--declare @DataApuracao AS DATE = '20130531'
SELECT 
...
FROM Dados.fn_RecuperaApolicesVigentes_PATRIMONIAL (@DataApuracao) AV
...
where AV.CodigoProduto in ('71','72')
