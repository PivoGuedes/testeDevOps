...
/*******************************************************************************
	Nome: CORPORATIVO.Marketing.fn_RecuperaApolicesVigentes_PATRIMONIAL
...
*******************************************************************************/ 
CREATE FUNCTION [Marketing].[fn_RecuperaApolicesVigentes_PATRIMONIAL] (@DataApuracao AS DATE)
RETURNS TABLE
AS
RETURN
SELECT 
        ...
        AV.CodigoComercializado, AV.[ProdutoComercializado], AV.MatriculaFuncionario,
