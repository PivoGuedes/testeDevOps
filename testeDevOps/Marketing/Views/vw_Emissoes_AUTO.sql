...
/*******************************************************************************
	Nome: CORPORATIVO.Marketing.vw_Emissoes_AUTO
...
*******************************************************************************/ 
CREATE VIEW Marketing.vw_Emissoes_AUTO
AS		
SELECT   AV.IDProposta,
        ...
        PA.Capacidade, PA.Combustivel, PA.CodigoSeguradora, SP.*      
FROM Dados.vw_Emissoes_AUTO  AV
