...
/*******************************************************************************
	Nome: CORPORATIVO.Dados.proc_InsereCorrespondente_CONSCBN
...
*******************************************************************************/
CREATE PROCEDURE [Dados].[proc_InsereCorrespondente_CONSCBN] 
AS
...
WHERE NomeEntidade = 'CADASTRO_CONSCBN'
...
/*********************************************************************************************************************/
    ...
    '  INSERT INTO dbo.CORRESPONDENTE_TEMP
       ...
       ''EXEC [Fenae].[Corporativo].[proc_recuperaCADASTRO_CONSCBN]''''' + @PontoDeParada + ''''''') PRP
         '
exec (@COMANDO)    
