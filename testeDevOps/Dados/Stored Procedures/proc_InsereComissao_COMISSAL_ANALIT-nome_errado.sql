...
/*******************************************************************************
	Nome: CORPORATIVO.Dados.proc_InsereComissao_COMISSAL_ANALIT
...
*/
CREATE PROCEDURE [Dados].[proc_InsereComissao_COMISSAL_ANALIT-nome_errado](@DataComissao DATE = NULL) 
AS
...
print '18'  
  ...
  ;MERGE INTO ControleDados.ExportacaoFaturamento AS T
	  USING (
        SELECT DISTINCT DataRecibo, NumeroRecibo, DataRecibo [DataCompetencia]
