...
CREATE PROCEDURE [Dados].[proc_RecuperaEscolaAmpliarIdentificacaoLotacao_Teste]
...
SELECT DISTINCT
99 [CorpID]
, CODIGOCENTROCUSTO [DepartamentoID]
, IDLotacao [LotacaoID]
, DescricaoCentroCusto [Descricao]
, SiglaLotacao [LotacaoSigla]
,CodigoCentroCusto [CentroDeCusto]
...
--EXECUTE sp_rename '[CORP]','[CorpID]', 'COLUMN'
