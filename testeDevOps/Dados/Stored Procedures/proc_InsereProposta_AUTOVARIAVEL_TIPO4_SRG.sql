...
/*******************************************************************************
	Nome: CORPORATIVO.Dados.proc_InsereProposta_AUTOVARIAVEL_TIPO4_SRG
...
*******************************************************************************/
CREATE PROCEDURE [Dados].[proc_InsereProposta_AUTOVARIAVEL_TIPO4_SRG] 
AS
...
WHERE NomeEntidade = 'Proposta_AUTOVARIAVEL_TIPO4_SRG'
...
/*********************************************************************************************************************/
    ...
    '  INSERT INTO dbo.AUTOVARIAVEL_TIPO4_SRG_TMP
     ...
     SELECT [Codigo],[NomeArquivo],[DataArquivo],[NumeroProposta],[DataHoraProcessamento],[TipoArquivo]
            ...
            ,[VersaoCalculo],[CodigoSeguradora],[CodigoRegiaoVistoriada],[CodigoTipoSeguro],[TipoSeguro], ''SRG'' --,[RANK]
       FROM OPENQUERY ([OBERON], 
       ''EXEC [Fenae].[Corporativo].[proc_RecuperaProposta_AUTOVARIAVEL_TIPO4_SRG] ''''' + @PontoDeParada + ''''''') PRP
         '
exec (@COMANDO)    
