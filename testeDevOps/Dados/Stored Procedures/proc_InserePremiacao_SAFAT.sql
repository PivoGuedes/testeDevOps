...
/*******************************************************************************
	Nome: CORPORATIVO.Dados.proc_InserePremiacao_SAFAT
...
*******************************************************************************/
CREATE PROCEDURE [Dados].[proc_InserePremiacao_SAFAT] 
AS
...
WHERE NomeEntidade = 'PREMIACAO_SAFAT'
...
/*********************************************************************************************************************/
    ...
    '  INSERT INTO dbo.PREMIACAO_SAFAT_TEMP
       ...
       ''EXEC [Fenae].[Corporativo].[proc_recuperaPremiacao_SAFAT]''''' + @PontoDeParada + ''''''') PRP
         '
exec (@COMANDO)    
