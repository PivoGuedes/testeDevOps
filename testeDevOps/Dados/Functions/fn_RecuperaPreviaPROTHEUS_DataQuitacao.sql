...
/*******************************************************************************
	Nome: CORPORATIVO.Dados.fn_RecuperaPreviaPROTHEUS_DataQuitacao
...
*******************************************************************************/ 
CREATE FUNCTION Dados.fn_RecuperaPreviaPROTHEUS_DataQuitacao(@PontoDeParadaIni DATE, @PontoDeParadaFim DATE)
RETURNS TABLE
AS
RETURN
--DECLARE @PontoDeParadaIni DATE = '2013-11-01'
--DECLARE @PontoDeParadaFim DATE = '2014-01-21'
...
(
 ...
 -- LINHA COMENTADA POR RAZÃO DE ADIÇÃO DE CAMPOS NA TABELA DE COMISSÃO, ONDE OBTEMOS O CALCULO PROPORCIONAL. AND C.CodigoComercializado NOT IN ('7705', '7707')   --RETIRA O PRESTAMISTA QUE É TRATADO NO UNION ABAIXO (1º UNION)
  ...
  AND C.CodigoComercializado NOT IN ('4007', '4500', '6700', '6701') --RETIRADO RISCOS ESPECIAIS 
