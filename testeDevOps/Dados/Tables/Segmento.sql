CREATE TABLE [Dados].[Segmento] (
    [ID]     SMALLINT     IDENTITY (1, 1) NOT NULL,
    [Codigo] CHAR (5)     NOT NULL,
    [Nome]   VARCHAR (50) NULL,
    CONSTRAINT [PK_Segmento_ID] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 100, DATA_COMPRESSION = PAGE)
);
...
CREATE TRIGGER [Dados].[Dados_Segmento_ChangeTracking] on [Dados].[Segmento] for insert, update, delete
...
select @TableName = 'Segmento'

select @TableSchema = 'Dados'

SELECT @TableName_Full = '[Dados].[Segmento]'
