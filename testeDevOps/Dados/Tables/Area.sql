CREATE TABLE [Dados].[Area] (
    [ID]        SMALLINT     NOT NULL,
    [Descricao] VARCHAR (70) NOT NULL,
    CONSTRAINT [PK_Area] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 100, DATA_COMPRESSION = PAGE)
);
...
CREATE TRIGGER [Dados].[Dados_Area_ChangeTracking] on [Dados].[Area] for insert, update, delete
...
SELECT @TableName_Full = '[Dados].[Area]'
